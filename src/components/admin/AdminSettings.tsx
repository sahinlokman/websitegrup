...
export const AdminSettings: React.FC = () => {
  ...
  const [generalSettings, setGeneralSettings] = useState({
    siteName: 'Telegram Grupları',
    siteDescription: 'En İyi Türkçe Telegram Gruplarını Keşfedin',
    siteLanguage: 'tr',
    contactEmail: 'info@telegramgruplari.com',
    contactPhone: '',
    contactAddress: ''
  });
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        onChange={handleGeneralChange}
                        className="w-full bg-gray-50 border border-gray-300 rounded-lg pl-10 pr-4 py-2 text-gray-900 focus:outline-none focus:ring-2 focus:ring-purple-500"
                      />
                    </div>
                  </div>
                  ...
                  <div className="bg-white shadow rounded-lg overflow-hidden" style={{
                    ...
                    <div className="p-4 border-b border-gray-200 flex items-center justify-between">
                      <div className="flex items-center space-x-3">
                        ...
                        <div className="font-bold">{generalSettings.siteName}</div>
                      </div>
...
// Import MessageCircle for the preview
